...
function generateRec(symbol) {
	...
	/////////////////////// CALLS //////////////////////////////////
		...
		for (let contractStrike in data.callExpDateMap[contractDate]) {
			...
			if (evalContrafct(contract, data, altData) && contractAboveVolatility(contract, data)) callArray.unshift(contract);
		}	       
		...
		} else { console.log("No call candidates"); console.log(callArray);		    
							    }
	...
	/////////////////////// PUTS //////////////////////////////////
		...
		if (candidate) {
			...
			console.log(candidate);
		} else { console.log("No candidates"); console.log(putArray);		    
							    }
	}
