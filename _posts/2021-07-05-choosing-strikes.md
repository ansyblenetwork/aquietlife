...
I have a huge gripe with that sentence, and here's why: A 0.5 delta contract is synonymous with an ATM contract. So the conclusion of their research was that an ATM contract is most premium-efficient.
