...
<div style="margin-bottom:20px;text-align:center" id="stocktwits">Trending on Stocktwits:</div>
...
function updateStocktwits() {
	...
	fetch("https://ansyble.herokuapp.com/cors/", 
		...
		stList = [];
		weeklyList = [];
		let stString = "Trending on Stocktwits with <strong>weeklys</strong> (" + new Date().toLocaleTimeString() + "):<br><br>";
