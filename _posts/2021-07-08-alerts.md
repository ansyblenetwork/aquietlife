		...
		if (data.status == "SUCCESS") {
			...
			for (let contractDate in data.callExpDateMap) {
				for (let contractStrike in data.callExpDateMap[contractDate]) {
					...
					addCol(contract.ask, "100px");
					addCol(contract.askSize, "100px");
					addCol(contract.bid, "100px");
					addCol(contract.bidSize, "100px");
					addCol(contract.last, "100px");
					addCol(contract.lastSize, "100px");
								       
					addCol(contract.totalVolume, "100px");
					addCol(contract.tradeTimeInLong, "100px");
					addCol(contract.daysToExpiration, "100px");
