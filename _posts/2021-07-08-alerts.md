...
function generateRec(symbol) {
	...
	/////////////////////// CALLS //////////////////////////////////
		...
		recData[symbol].data.daysToExpiration = defData.contract.daysToExpiration;
		if (candidate) {
...
function buildRec(symbol) {
	...
	/////////////////////// MIDDLE //////////////////////////////////
		...
		addCol(recData[symbol].data.symbol + " " + recData[symbol].data.daysToExpiration + " DTE", "675px", referenceli);
