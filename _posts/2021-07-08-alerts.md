...
function optionsChain() {	
	...
	fetch("https://api.tdameritrade.com/v1/marketdata/chains?apikey=T1V8GYUYK3GKC7HG3L23O9XBJ5OH1C4F&symbol="
		...
		if (data.status == "SUCCESS") {
			...
			function buildTitle(contract, height) {
				let li = make('li');
				...
				if (contract.putCall == "CALL") {
					li.style.bottom = "0px";
					if (height) li.style.zIndex = height;
				}
				else li.style.top = "0px";
			...
			/////////////////////// CALLS //////////////////////////////////
				...
				buildTitle(contract, height); height--;
			...
			/////////////////////// PUTS //////////////////////////////////
				...
				referenceli = buildTitle(contract);
