...
<button onclick="updateAll();" style="position:fixed; bottom: 10px;">Refresh Sources</button><button id="mergeButton" style="margin:0px auto 20px auto; display:block;" onclick="mergeAll()">Load and Rank</button>
