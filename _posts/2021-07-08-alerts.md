...
<input id="defaultLower" onblur="defaultLower = parseFloat(this.value)" type="text" autocomplete="off" value="2" placeholder="Lower margin..."> 
...
<input id="defaultUpper" onblur="defaultUpper = parseFloat(this.value)" type="text" autocomplete="off" value="2" placeholder="Upper margin..."> 
</div>
