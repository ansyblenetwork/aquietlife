...
<div style="margin-bottom:10px; text-align:center" id="merge">Top 5 from each source</div>
<button id="mergeButton" style="margin:0px auto 20px auto; display:block;" onclick="mergeAll()">Rank by options</button>
...
function addAll(dataset) {
	console.log("attempting to add all.");
	console.log(dataset);
...
function mergeAll() {
	...
	let mergeString = "";
	for (let i = 0; (i < merge.length) && (i < 5); i++) {
