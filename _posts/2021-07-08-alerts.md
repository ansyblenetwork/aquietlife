...
function mergeAll() {
	...
	Promise.all(promises).then(function() {
		...
		for (let i = 0; i < maxdata.length; i++) {
			...
			mergeString += `<strong style="cursor:pointer; color:darkMagenta" onclick="D('optionsInput').value = '${maxdata[i].symbol}'; optionsChain()" style='color:#333'>${maxdata[i].symbol}</strong> `;
	...
	fetch("https://ansyble.herokuapp.com/cors/", 
		...
		if (data.quoteResponse.result) {
			...
			earnings.forEach(function(stock) {
				...
				+ "' target='_blank' href='https://finance.yahoo.com/quote/" + stock + "'><strong style='color:darkMagenta'>" + stock + "</strong></a> ";							      
			});
