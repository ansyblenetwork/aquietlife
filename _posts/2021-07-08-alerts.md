...
id="tickerInput" style="margin-right:20px; margin-bottom:20px" autocomplete="off" placeholder="Add stock ticker..."> 
<span id="msg"></span>
<div id="ticker"></div>
<div id="market"></div>
...
function submitTicker() {
	...
	if (buffer) {	
		...
		D('msg').textContent = "Ticker: " + stock;
		D('msg').textContent += "     Market: " + buffer.regularMarketPrice;
