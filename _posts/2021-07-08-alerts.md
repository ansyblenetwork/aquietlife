...
<div style="margin-bottom:20px; text-align:center">Gainers on <a target='_blank' href='https://finviz.com/screener.ashx?v=150&f=sh_opt_option&o=-change'><strong style='color:#333'>Finviz</strong></a> (no API)</div>
...
<div style="margin-bottom:10px; text-align:center; padding-top:20px; border-top:solid" id="merge">Top 5 from each source, ranked by options</div>
	<div style="margin-bottom:20px; text-align:center">
<button onclick="updateAll();">Refresh Sources</button><button id="mergeButton" onclick="mergeAll()">Load and Rank</button>
	</div>
