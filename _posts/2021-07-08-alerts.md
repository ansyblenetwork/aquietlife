...
<input id="defaultLower" onkeyup="defaultLower = this.value" type="text" autocomplete="off" value="2" placeholder="Lower margin..."> 
<input id="defaultUpper" onkeyup="defaultUpper = this.value" type="text" autocomplete="off" value="2" placeholder="Upper margin..."> 
</div>
...
setInput(defaultLower); 
setInput(defaultUpper);
