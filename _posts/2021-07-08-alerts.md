...
function checkDefData(defData, altData, contract) {
		...
		if (data.status == "SUCCESS") {
			...
			/////////////////////// CALLS //////////////////////////////////
				...
				for (let contractStrike in data.callExpDateMap[contractDate]) {	
					checkDefData(defData, altData, data.callExpDateMap[contractDate][contractStrike][0]);
				}	
			...
			/////////////////////// PUTS //////////////////////////////////
				...
				for (let contractStrike in data.putExpDateMap[contractDate]) {	
					checkDefData(defData, altData, data.putExpDateMap[contractDate][contractStrike][0]);
				}	
