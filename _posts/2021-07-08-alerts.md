...
A stock alert applet. Issues a ring/notification for price movements beyond a specified range. A ring and/or notification will also emit when a stock exhibits an unusually large change in price or volume. This is tuned for events on the intra-day scale.
