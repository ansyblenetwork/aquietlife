...
<button onclick="toggleSound(this);" id="soundButton" class="active">Sound On</button><button onclick="toggleNotifications(this);" id="notificationButton">Notifications Off</button>
<button onclick="toggleAlerts(this);" style="float:right">Auto-Refresh Off</button>
<button onclick="update(); updateStocktwits();" style="float:right">Refresh</button>
<span id="msg" style="margin-right:10px; float:right"></span>
</div>
