		...
		if (data.status == "SUCCESS") {
			...
			for (let contractDate in data.callExpDateMap) {
				for (let contractStrike in data.callExpDateMap[contractDate]) {
					...
					addCol(contract.ask, "50px");
					addCol(contract.askSize, "50px");
					addCol(contract.bid, "50px");
					addCol(contract.bidSize, "50px");
					addCol(contract.last, "50px");
					addCol(contract.lastSize, "50px");
