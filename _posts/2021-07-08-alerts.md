...
<button onclick="update(); updateAll();" style="position:fixed; bottom: 10px;">Refresh</button>
...
<div style="margin-bottom:10px; text-align:center; padding-top:10px; border-top:solid" id="merge">Top 5 from each source, ranked by options</div>
...
<ul style="list-style-type:none; padding-left:0px;padding-bottom:10px; border-bottom:solid" id="optionslist"></ul>
