...
<div style="margin-bottom:10px; text-align:center" id="merge">Top 5 from each source, ranked by options</div>
	<div style="margin:0px auto 20px auto; display:block;">
<button onclick="updateAll();" style="position:fixed; bottom: 10px;">Refresh Sources</button><button id="mergeButton" onclick="mergeAll()">Load and Rank</button>
	</div>
