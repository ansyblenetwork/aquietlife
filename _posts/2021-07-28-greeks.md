...
the primary responsibility of a trader trading options should not be to understand universal pricing models or algorithmic strategies. Calculators and computers do a far better job of this  (and in any case, they should be very simple). Rather, the trader should be primarily occupied by trying to understand the underlying to gain an opportunistic edge.
