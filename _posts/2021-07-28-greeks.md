...
there is one use case I can accept. Options Greeks are perhaps not too useful for discovering additional insights about a financial instrument in isolation, but it is useful to provide a quantiative comparison about pairs or baskets of instruments - a necessarily complicated situation which requires some reduction to work with. This is fair. Unfortunately, I think the truth of the situation is that the typical retail trader relying on the Greeks rarely has such a mathematically disciplined framework.
