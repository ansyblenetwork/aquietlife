		...
		if (data.status == "SUCCESS") {
			...
			for (let contractDate in data.callExpDateMap) {
				for (let contractStrike in data.callExpDateMap[contractDate]) {
					...
					if (contract.bid > 0 && returnrate > 7 && lastTrade < 12*60) {
					...
					addCol(data.symbol + " $" + data.underlyingPrice, "150px");								       
					...
					addCol(lastTrade + "min, "50px");
								       
					if (contract.putCall == "CALL") 
						addCol(Math.round(100*(contract.strikePrice - data.underlyingPrice)/data.underlyingPrice) + "%", "100px");
					else addCol(Math.round(100*(data.underlyingPrice - contract.strikePrice)/data.underlyingPrice) + "%", "100px");
					addCol(returnrate + "%", "100px");
