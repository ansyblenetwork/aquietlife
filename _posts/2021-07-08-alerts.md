...
1. The data comes from Yahoo Finance, 
2. Yahoo finance allows servres to access their API but not static sites. I am using a free Heroku backend for this, which sleeps after inactivity. This means that the first quote might take a few seconds as the backend wakes up. All quotes thereafter should be reasonably speedy.
