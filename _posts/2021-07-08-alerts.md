...
<div style="margin-bottom:20px;text-align:center" id="stocktwits">[Trending tickers on Stocktwits with <strong>weeklys</strong>]</div>
<button style="margin:0 auto" onclick="D('tickerInput').value = weeklyList.join(); submitTicker();">Add Weeklys</button>
