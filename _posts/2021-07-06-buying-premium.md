...
More generally, there is no reason to think that the case for shorting options should be ignored depending on your trading circumstance. In fact, adherence to the rule is the whole point of being an options seller. The service of an option seller is to be willing to go through some inconvenience to develop risk management for oneself, rather than paying someone else to handle it.
