...
<input id="defaultLower" onblur="defaultLower = this.value" type="text" autocomplete="off" value="2" placeholder="Lower margin..."> 
...
<input id="defaultUpper" onblur="defaultUpper = this.value" type="text" autocomplete="off" value="2" placeholder="Upper margin..."> 
</div>
