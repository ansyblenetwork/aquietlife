...
function updateFinvizG() {
	...
	fetch("https://ansyble.herokuapp.com/cors/", 
		...
		data.symbols.forEach(function(stockData) {
			stString += printWeekly(stockData.symbol, finvizGList, finvizGWeeklyList, prevWeekly, "Finviz gainers", stockData.title);
		});
...
function toggleAlerts(elt) {
	if (yahootimer) {
		...
		sttimer = setInterval(function() { updateStocktwits(); updateFinvizG(); }, 60000);
