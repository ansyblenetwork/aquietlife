...
<div style="margin-bottom:10px; text-align:center" id="stocktwits">Trending on <a target='_blank' href='https://stocktwits.com/'><strong color="#333">Stocktwits</strong></a> with <strong>weeklys</strong></div>
...
<div style="margin-bottom:10px; text-align:center" id="yolo">Trending on <a target='_blank' href='https://yolostocks.live/'><strong color="#333">YoloStocks</strong></a> with <strong>weeklys</strong></div>
...
<div style="margin-bottom:10px; text-align:center" id="wsb">Trending on <a target='_blank' href='https://dashboard.nbshare.io/apps/reddit/wallstreetbets/'><strong color="#333">WSB</strong></a> with <strong>weeklys</strong></div>
...
<div style="margin-bottom:10px; text-align:center" id="earnings"><a target='_blank' href='https://finance.yahoo.com/calendar/earnings'><strong color="#333">Earnings</strong></a> within a week with <strong>weeklys</strong></div>
...
function updateYolo() {
	...
	fetch("https://ansyble.herokuapp.com/cors/", 
		...
		yoloWeeklyList = [];
		let yoloString = "<a target='_blank' href='https://yolostocks.live/'><strong color="#333">YoloStocks</strong></a> (" + new Date().toLocaleTimeString() + "): ";
...
function updateWSB() {
	...
	fetch("https://ansyble.herokuapp.com/cors/", 
		...
		wsbWeeklyList = [];
		let wsbString = "<a target='_blank' href='https://dashboard.nbshare.io/apps/reddit/wallstreetbets/'><strong color="#333">WSB</strong></a> (" + new Date().toLocaleTimeString() + "): ";
		for (let i = 0; i < 15; i++) {
...
function updateStocktwits() {
	...
	fetch("https://ansyble.herokuapp.com/cors/", 
		...
		stWeeklyList = [];
		let stString = "<a target='_blank' href='https://stocktwits.com/'><strong color="#333">Stocktwits</strong></a> (" + new Date().toLocaleTimeString() + "): ";
